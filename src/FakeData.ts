...
const productsData: ProductInfo[] = [
  ...
  // Bedroom-here
  {
    imgSource: '//cdn.shopify.com/s/files/1/1087/6904/products/83fa05ceb61f887a7e5731c2cd61f181_large.jpg?v=1571438954',
  ...
  {
    imgSource: '//cdn.shopify.com/s/files/1/1087/6904/products/74206e25b52217e11c1980cba6ee9abc_large.jpg?v=1571439020',
    productName: 'Vertical Mini Library',
    productPrice: 760,
    category: 'bedRoom',
    type: 'Bookshelves',
    quickShip: false,
